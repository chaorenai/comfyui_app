...
class FloatUnaryOperation:
    ...
    RETURN_TYPES = ("FLOAT",)
    FUNCTION = "op"
    CATEGORY = "comfyui_app/match/float"
...
NODE_CLASS_MAPPINGS = {
    "comfyui_app:FloatUnaryOperation": FloatUnaryOperation,
    "comfyui_app:FloatUnaryCondition": FloatUnaryCondition,
    "comfyui_app:FloatBinaryOperation": FloatBinaryOperation,
    "comfyui_app:FloatBinaryCondition": FloatBinaryCondition,
}
