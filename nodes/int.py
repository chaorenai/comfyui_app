...
class IntUnaryOperation:
    ...
    RETURN_TYPES = ("INT",)
    FUNCTION = "op"
    CATEGORY = "comfyui_app/match/int"
...
NODE_CLASS_MAPPINGS = {
    "comfyui_app:IntUnaryOperation": IntUnaryOperation,
    "comfyui_app:IntUnaryCondition": IntUnaryCondition,
    "comfyui_app:IntBinaryOperation": IntBinaryOperation,
    "comfyui_app:IntBinaryCondition": IntBinaryCondition,
}
